<template>
  <section class="booking-detail__flight-item">
    <div class="flight-item__title">
      ...
      <a v-if="hasDetailButton" class="btn-link" @click="$emit('showDetail')">
        {{ t('see_detail') }}
      </a>
    </div>
    ...
    <div class="flight-item__route">
      ...
      <div class="flight-item__route-time">
        ...
        <span
          >{{ segmentOrigin.DepartTime }} - {{ segmentDepart.ArriveTime }}</span
        >
...
import { Segment as ISegment, Departure as IDeparture } from './types';
