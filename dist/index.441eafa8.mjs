...
const E = { class: "ma-card-section__header-flashsale" }, q = /* @__PURE__ */ e("div", { class: "flashsale flashsale__icon" }, [
  ...
  setup(d) {
    ...
    return $(() => {
      ...
      q,
      a(t).name ? (c(), r("h1", H, _(a(t).name), 1)) : u("", !0),
      a(t).countdown ? (c(), r("div", N, [
        O,
  ...
  setup(d) {
    ...
    return (o, i) => (c(), r("div", T, [
      a(t).name ? (c(), r("h1", F, _(a(t).name), 1)) : u("", !0)
    ]));
  }
}), A = {
  en: {
