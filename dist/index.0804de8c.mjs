import { defineComponent as g, computed as b, openBlock as d, createElementBlock as f, createElementVNode as o, toDisplayString as e, unref as t, ref as w, Fragment as y, createVNode as m, withCtx as c, reactive as p, createTextVNode as x, createBlock as v, createCommentVNode as z, defineCustomElement as D } from "vue";
import { _ as C, H as $, a as T } from "./ModalPeek.vue_vue_type_script_setup_true_lang.c5f253da.mjs";
import { S as E } from "./booking-confirmation-status-order-mobile.e76c29a3.mjs";
import { t as S } from "./index.ba6cd7a3.mjs";
import { u as j } from "./vue-i18n.esm-bundler.9ad5361b.mjs";
import { _ as N } from "./_plugin-vue_export-helper.e9cbb45e.mjs";
const F = "/booking-confirmation/arrow-right.svg", h = "/booking-confirmation/vector.svg", A = { class: "flight" }, B = { class: "title-flight" }, O = { class: "airline" }, P = { class: "img-airline" }, M = ["src"], K = { class: "name-airline" }, J = { class: "card-flight" }, V = { class: "content-card" }, H = { class: "airport" }, I = /* @__PURE__ */ o("img", {
  src: F,
  width: "10"
}, null, -1), U = { class: "schedule" }, G = /* @__PURE__ */ o("span", null, [
  /* @__PURE__ */ o("img", {
    src: h,
    width: "4"
  })
], -1), L = /* @__PURE__ */ o("span", null, [
  /* @__PURE__ */ o("img", {
    src: h,
    width: "4"
  })
], -1), R = /* @__PURE__ */ o("span", null, [
  /* @__PURE__ */ o("img", {
    src: h,
    width: "4"
  })
], -1), _ = /* @__PURE__ */ g({
  __name: "booking-confirmation-flight-mobile",
  props: {
    title: null,
    segments: null,
    t: null
  ...
  setup(n) {
    const { title: a, segments: r, t: s } = n, i = b(() => r.Departure[0]), l = b(
      () => r.Departure[r.Departure.length - 1]
    );
    return console.log(r), (u, k) => (d(), f("div", A, [
      o("div", B, [
        o("span", null, e(n.title), 1)
      ]),
      o("div", O, [
        o("div", P, [
          o("img", {
            src: t(i).AirlineImageUrl
          }, null, 8, M)
        ]),
        o("div", K, [
          o("div", null, e(t(i).AirlineName), 1),
          o("span", null, e(t(i).ClassCategory) + " (Subclas " + e(t(i).ClassCode) + ")", 1)
        ])
      ]),
      o("div", J, [
        o("div", V, [
          o("div", H, [
            o("span", null, e(t(i).OriginCityName) + " (" + e(t(i).Origin) + ") ", 1),
            I,
            o("span", null, e(t(l).DestinationCityName) + " (" + e(t(l).Destination) + ")", 1)
          ]),
          o("div", U, [
            o("span", null, e(t(S)(t(i).DepartDate)), 1),
            G,
            o("span", null, e(t(i).DepartTime) + " - " + e(t(l).ArriveTime), 1),
            L,
            o("span", null, e(n.segments.TravelTimeDepart), 1),
            R,
            o("span", null, e(n.t("isTransit", n.segments.TotalTransitDepart)), 1)
          ])
        ])
      ])
    ]));
  }
}), q = "/booking-confirmation/cupon.svg", Q = /* @__PURE__ */ o("div", { class: "title" }, "Kode Promo", -1), W = /* @__PURE__ */ o("img", { src: q }, null, -1), X = [
  W
], Y = /* @__PURE__ */ o("div", { class: "title" }, "Kode Promo", -1), Z = /* @__PURE__ */ o("button", { class: "btn btn-primary" }, "Gunakan", -1), oo = /* @__PURE__ */ g({
  __name: "booking-confirmation-promocode-mobile",
  setup(n) {
    const a = w(!1), r = () => {
      a.value = !a.value;
    };
    return (s, i) => (d(), f(y, null, [
      o("div", { class: "promo-code" }, [
        Q,
        o("div", { class: "cupon" }, [
          o("a", { onClick: r }, X)
        ])
      ...
      m(C, {
        show: a.value,
        "onUpdate:show": i[1] || (i[1] = (l) => a.value = l),
        onClose: i[2] || (i[2] = (l) => a.value = !1),
...
}), eo = { class: "price-detail" }, io = { class: "title" }, to = { class: "price" }, no = { class: "subtotal" }, ro = { class: "total" }, ao = { class: "include-tax" }, lo = /* @__PURE__ */ g({
  __name: "booking-confirmation-detail-price-mobile",
  props: {
    reservation: null,
    t: null
  },
  setup(n) {
    const { reservation: a, t: r } = n, s = b(() => a.Currency);
    return (i, l) => (d(), f("div", eo, [
      o("div", io, e(n.t("price_detail")), 1),
      o("div", to, [
        o("div", no, [
          o("span", null, e(n.t("subtotal")), 1),
          o("span", null, e(t(s)) + " " + e(n.reservation.Total), 1)
        ]),
        o("div", ro, [
          o("span", null, e(n.t("total")), 1),
          o("span", null, e(t(s)) + " " + e(n.reservation.TotalAfterDiscount), 1)
        ])
      ]),
      o("div", ao, "*" + e(n.t("tax")), 1)
    ]));
  }
}), so = {
  en: {
    confirmation: "Confirmation",
    time_limit: "Payment deadline",
    departure: "Departure",
    return: "Return",
    isTransit: "Direct | Transit",
...
}, mo = { id: "booking-confirmation-mobile" }, po = /* @__PURE__ */ g({
  __name: "booking-confirmation-mobile.ce",
  props: {
    data: null,
    reservation: null
  },
  setup(n) {
    const a = n, { t: r } = j({ messages: so }), s = p(
      a.reservation ? JSON.parse(a.reservation) : null
    ), i = p(a.data ? JSON.parse(a.data) : null), l = p(
      i.segment1 ? JSON.parse(i.segment1) : null
    ), u = p(
      i.segment2 ? JSON.parse(i.segment2) : null
    );
    return (k, bo) => (d(), f("div", mo, [
      m($, null, {
        default: c(() => [
          x(e(t(r)("confirmation")), 1)
        ]),
        _: 1
      }),
      m(E, {
        reservation: s,
        t: t(r)
      }, null, 8, ["reservation", "t"]),
      m(_, {
        title: t(r)("departure"),
        segments: l.Segments,
        t: t(r)
      }, null, 8, ["title", "segments", "t"]),
      i.trip === "2" ? (d(), v(_, {
        key: 0,
        title: t(r)("return"),
        segments: u.Segments,
        t: t(r)
      }, null, 8, ["title", "segments", "t"])) : z("", !0),
      m(oo),
      m(lo, {
        reservation: s,
        t: t(r)
